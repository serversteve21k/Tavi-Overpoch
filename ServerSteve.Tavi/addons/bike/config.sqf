...
DZE_DEPLOYABLES_CONFIG = [
    // deploy a non-permanent bike from a toolbox right in front of the player that can be re-packed by the owner as long as it's under 10% damage
 	["ItemToolbox",[0,6,1],5,0.1,false,false,false,false,false,true,true,["MMT_Civ"],[],["PartGeneric"],"true"],
	["ItemToolbox",[0,6,1],5,0.1,false,false,false,false,false,true,true,["TT650_Base"],[],["PartGeneric","PartWheel","PartEngine"],"true"],
	["ItemToolbox",[0,8,2],7,0.1,false,false,false,false,false,true,true,["CSJ_GyroC"],[],["PartVRotor","PartEngine","PartGeneric"],"true"]
