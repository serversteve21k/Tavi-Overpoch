...
#define START_ITEMS "ItemSodaRbull","FoodMRE","PartGeneric","ItemPainkiller","ItemBandage","ItemBandage"

class_public = [ // These are visible to anyone on the server
	[(localize "str_playerstats_bandit")+" Lvl3 -25k","GUE_Commander_DZ","BB_Merc_OA_Female_light",[START_ITEMS,"ItemBandage","ItemBandage","30Rnd_9x19_UZI","30Rnd_9x19_UZI","ItemAntibiotic","ItemBloodbag","ItemMorphine","ItemPainkiller"],["PDW_DZ","ItemKnife","ItemEtool","ItemCrowbar","ItemToolbox","ItemGPS","ItemRadio"],"DZ_GunBag_EP1",[],[],0,-25000,0],
	[(localize "str_playerstats_bandit")+" Lvl2 -15k","Bandit2_DZ","BB_Merc_OA_Female_light",[START_ITEMS,"ItemBandage","ItemBandage","6Rnd_45ACP","6Rnd_45ACP","ItemAntibiotic","ItemBloodbag"],["Revolver_DZ","ItemKnife","ItemEtool","ItemCrowbar","ItemToolbox","ItemGPS","ItemRadio"],"DZ_British_ACU",[],[],0,-15000,0],
	[(localize "str_playerstats_bandit")+" Lvl1 -5k","Bandit1_DZ","BB_Merc_OA_Female_light",[START_ITEMS,"15Rnd_9x19_M9","15Rnd_9x19_M9","ItemAntibiotic","ItemBloodbag"],["M9_DZ","ItemKnife","ItemEtool","ItemCrowbar","ItemToolbox","ItemGPS","ItemRadio"],"DZ_TK_Assault_Pack_EP1",[],[],0,-5000,0],
	[localize "str_playerstats_survivor","Haris_Press_EP1_DZ","BB_Merc_OA_Female_light",[START_ITEMS,"15Rnd_9x19_M9"],["M9_DZ","ItemKnife","ItemEtool","ItemCrowbar","ItemToolbox","ItemGPS","ItemRadio"],"DZ_Patrol_Pack_EP1",[],[],0,0,0],
	[(localize "str_playerstats_hero")+" Lvl1 5k",if (class_epoch) then {"Camo1_DZ"} else {"Survivor3_DZ"},"BB_Merc_OA_Female_light",[START_ITEMS,"15Rnd_9x19_M9","15Rnd_9x19_M9","ItemAntibiotic","ItemBloodbag"],["M9_DZ","ItemKnife","ItemEtool","ItemCrowbar","ItemToolbox","ItemGPS","ItemRadio"],"DZ_TK_Assault_Pack_EP1",[],[],0,5000,0],
	[(localize "str_playerstats_hero")+" Lvl2 15k",if (class_epoch) then {"Survivor3_DZ"} else {"Survivor3_DZ"},"BB_Merc_OA_Female_light",[START_ITEMS,"ItemBandage","ItemBandage","6Rnd_45ACP","6Rnd_45ACP","ItemAntibiotic","ItemBloodbag"],["Revolver_DZ","ItemKnife","ItemEtool","ItemCrowbar","ItemToolbox","ItemGPS","ItemRadio"],"DZ_British_ACU",[],[],0,15000,0],
	[(localize "str_playerstats_hero")+" Lvl3 25k",if (class_epoch) then {"Soldier_PMC"} else {"Survivor3_DZ"},"BB_Merc_OA_Female_light",[START_ITEMS,"ItemBandage","ItemBandage","30Rnd_9x19_UZI","30Rnd_9x19_UZI","ItemAntibiotic","ItemBloodbag","ItemMorphine","ItemPainkiller"],["PDW_DZ","ItemKnife","ItemEtool","ItemCrowbar","ItemToolbox","ItemGPS","ItemRadio"],"DZ_GunBag_EP1",[],[],0,25000,0]
];
