...
/*
_messages = [
	["Dayz Tavi Overpoch", "Welcome "+(name player)],
	["World", worldName],
	["Host", "Hosted ServerSteve"],
	["Server Rules", "Duping, glitching or using any<br />exploit will result in a<br />permanent ban."],
	["Server Rules", "No voice in side."],
...
_messages = [
	...
	["Server Rules", "Respect others"],
	["Server Rules", "No whining."],
	["News", "Server is under construction!"]
];
