...
_serverName = " UK ServerSteve Tavi Overpoch "; // the server name that will go accross the top of the menu

_ts3IP = " discord.gg/XgyFnkH "; // ts3 ip that will go at the bottom of the menu
...
_info2Text = "Base Rules"; //Text that will go on info button 2
info2script = {((ctrlParent (_this select 0)) closeDisplay 7777); execvm 'custom\menu\rules3_init.sqf';}; //script that info button 1 will use
...
(_finddialog displayCtrl 1000) ctrlSetText format["%1",_serverName];
};
